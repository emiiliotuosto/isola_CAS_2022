...
\newcommand{\eMcomm}[2][check]{
  \todo[fancyline,color=orange!10]{\tiny eM: \color{Navy}#1}
%  \begin{markbox}
	 {\color{OliveGreen}{#2}}
%  \end{markbox}
}
...
\newcommand{\tnxitmatters}[1][{Work partly funded}]{
  %
  #1 by MIUR project PRIN 2017FTXR7S \emph{IT MATTERS}
  (Methods and Tools for Trustworthy Smart Systems)
}

\newcommand{\tnxseduce}[1][{Work partly funded}]{
  %
  #1 by MIUR project PRIN 2017TWRCNB \emph{SEDUCE} 
...
\newcommand{\hsl}[1][]{\iffinal\else\par
